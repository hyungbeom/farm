...
export default function Side() {
    ...
    const tabs = ['제주도 체험', '체험 프로그램', '체육대회'];
    ...
    const tabData = {
        '제주도 체험': {
            ...
            cards: [
                {
                    title: '제주 꽃차 시음회',
                    desc: '제주의 자연을 담은 꽃차를 직접 맛보며 향긋한 제주만의 여유를 느껴보는 시간입니다. 은은한 꽃향기와 부드러운 풍미가 어우러진 다양한 꽃차를 시음하며' +
                        '제주가 가진 따뜻한 감성과 힐링의 매력을 편안하게 즐겨보세요',
                    timeDo: '3월 31일(화) ~ 4월 1일(수) 10:00 ~ 18:00',
                    place: '행사장 內 체험존',
                    target: '행사장 방문객 누구나 (재료 소진 시까지)',
                    do: '1. 무료체험\n 2. 진행요원의 안내에 따라 시음 진행',
                    // time: '5 ~ 10분',
                    img: '/program/side13.png'
                },
                {
                    title: '제주 지름떡(기름떡) 시식회',
                    desc: '제주 지름떡(기름떡)은 참살가루를 반죽해 별 모양으로 빚어 기름에 지진 후 설탕을 뿌려 먹는 제주의 달콤한 전통 간식입니다. 겉은 바삭하고 속은 쫀득한 식감이 일품인 제주의 옛 맛을 직접 경험해 보세요.',
                    timeDo: '3월 31일(화) ~ 4월 1일(수) 10:00 ~ 18:00',
                    place: '행사장 內 체험존',
                    target: '행사장 방문객 누구나 (재료 소진 시까지)',
                    do: '1. 무료체험\n 2. 진행요원의 안내에 따라 시음 진행',
                    // time: '5 ~ 10분',
                    img: '/program/side14.png'
                },
